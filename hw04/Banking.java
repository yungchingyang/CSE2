...
//      
        if ( nDeposit >= 0 ) {  //enter the condition if the deposit input is positive
//          
...
//        
        else if ( nDeposit < 0 ) {  //enter the condition if the deposit is negative
//            
...
//      
        System.out.print("How much do you want to withdraw (Please enter a positive number with 2 decimal places) ?  $");   //prompt the user to state the desired number to deposit
        double nWithdraw = myScanner.nextDouble();    //accept user input of withdrawal money
//      
        if( nWithdraw >= 0 ) {  //enter the condition if the withdraw money is positive
//          
...
//          
        ...
        else if ( nWithdraw < 0 ) { //enter the condition if the withdraw is negative
//            
            System.out.println("Please enter a positive number with 2 decimal places. Try over again. ");   //show the advice
            return; //quit the program
//          
        }
//      
        else {  //enter the condition if the input is invalid
//         
           System.out.println("Invalid input. Try again. ");    //show the error message
           return;  //quit the program
//          
